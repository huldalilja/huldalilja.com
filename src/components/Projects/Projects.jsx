...
import LostInCodelogo from "../../assets/lostincode.png";
                    ...
                    <div className="page">
                        <div className="projects">
                            ...
                            <div className="row">
                                ...
                                <Card logo={LostInCodelogo} companyName="LostInCode.blog" companyLink="https://lostincode.blog" alt="LostInCode's logo" 
                                    folded={true}
                                    period="Started summer 2017" 
                                    description="Computer Science's related blog I write with two of my friends"
                                    back={(<p>Three computer scientists graduates from Reykjavík University in Iceland writing a blog about subjects and topics that interest and affect us while studying computer science. <a target="_blank" rel="noopener noreferrer" href="https://lostincode.blog">Read on</a>.</p>)}>
                                </Card>
                                <Card logo={HLHlogo} companyName="huldalilja.com" companyLink="https://datawell.ru.is" alt="Sheep Of Iceland's logo" 
                                    period="Made in 2018" 
                                    description="My old website"
                                    back={(<p>My old wesite, stopped updating in the spring 2020. I made a <a target="_blank" rel="noopener noreferrer" href="https://lostincode.blog/2018/10/23/online-cv/">blog post</a> with some notes on how I made it.</p>)}>
                                </Card>
                                <Card logo={SheepOfIcelandlogo} companyName="Sheep Of Iceland" companyLink="https://huldalilja.com/huldaliljaold" alt="Sheep Of Iceland's logo" 
                                    period="Made in the spring 2017" 
                                    description="Collect sheeps in Iceland"
                                    back={(<p>Unity game made in a three week course at Reykjavík University with two of my fellow friends. The player is a shepherd girl that travels around Iceland collecting her lost sheep.</p>)}>
                                </Card>
                            </div>
                        </div>
                    </div>
