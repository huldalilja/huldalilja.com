...
import Googlelogo from "../../assets/media/googlelogo.png";
...
const works = [
    {
        ...
        description:"Site Reliability Engineering Intern",
        back:(<p>Worked within privacy, safety and security. Used Python, Java and Google speciﬁc technologies for building, testing and deploying. Project included revamping how conﬁgurations are managed and deployed.</p>)
    },
    {
        logo:Reglalogo,
        ...
        back:(<p>Designed and developed the company’s first cross-platform mobile app(Xamarin Forms), available on android and iOS. Made a responsive website(ASP.NET) with a better acces to some of the company’s features as well as new ones.</p>)
    },
    {
        logo:HRDatawelllogo, 
        companyName:"Reykjavík University - Datawell", 
        companyLink:"https://datawell.is",
        period:"August 2018 - Fall 2020" ,
        description:"Research assistant, working as a full-stack developer",
        back:(<p>Designed and developed a sport and health data platform in Django and React for the Sports Science Department. Automatically gathering consecutive and single measurements and visualizing the data.</p>)
    },
    {
        logo:Mimirlogo, 
